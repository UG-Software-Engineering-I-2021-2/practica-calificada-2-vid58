...
public class PrincipalTest {
    ...
    @Test
    void Teacher_ExtraPoint(){
        Principal Names = new Principal(2020);
        List<String> teachers = new ArrayList<>();
        teachers.add("Josefina");
        teachers.add("Edonisio");

        Assert.assertEquals(teachers, Names.Teachers());
    }

    @Test
    void Strudent_ExtraPoint() {
        Principal Names = new Principal(2020);
        final List<Pair<Student, Integer>> students =
                List.of(
                new Pair<>( new Student("David"), 2020),
                new Pair<>( new Student("Pedro"), 2020)
        );
        ...
        Assert.assertEquals(Students, Names.Students(students));
    }
